...
class ExpressShopPagebyKestrel extends AbstractHandler {
    public function is_active(): bool {
        return $this->is_plugin_active('woocommerce-express-shop-page/woocommerce-express-shop-page.php');
    }
    ...
    /**
     * Modify the script enqueue condition to include shop pages when Express Shop is active
     *
    ...
    public function modify_script_enqueue($should_enqueue): bool {
        ...
        // Add enqueue for shop pages when Express Shop is active
